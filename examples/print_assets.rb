...
startSeachTime = 1400291695000;
monthMs=259200000 #one Month in milliseconds
...
q = Cts::Mpx::Query.create(account: account, service: service, endpoint: endpoint, fields: returnFields,range: '1-4', query: {byAdded: addedQString, sort: 'added|desc'}).run user: user
